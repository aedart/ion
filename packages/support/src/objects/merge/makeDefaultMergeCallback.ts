 ...
 */
export function makeDefaultMergeCallback(): MergeCallback
{
    return function(target: MergeSourceInfo, next: NextCallback, options: Readonly<MergeOptions>): any /* eslint-disable-line @typescript-eslint/no-explicit-any */
    {
        const {
            result,
            key,
