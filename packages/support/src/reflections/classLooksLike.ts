...
import { includesAll } from "../arrays/includesAll.js";
import { hasPrototypeProperty } from "./hasPrototypeProperty.js";
import { classOwnKeys } from "./classOwnKeys.js";
 ...
 *
 * @throws {TypeError} If target object does not have "prototype" property. Or, blueprint is invalid.
 */
