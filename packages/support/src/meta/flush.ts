 ...
 * @param {Record<PropertyKey, unknown>} staged The metadata object from decorator context
 *
 * @internal
 */
export function flush(owner: ConstructorLike, staged: Record<PropertyKey, unknown>): void
{
