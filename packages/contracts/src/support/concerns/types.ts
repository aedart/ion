 ...
 */
export const CONCERN_CLASS: unique symbol = Symbol('@aedart/contracts/support/concerns/concern-class');
 ...
 */
export const CONCERN_REGISTRY: unique symbol = Symbol('@aedart/contracts/support/concerns/registry');
 ...
 */
export const APPLIED_ALIASES: unique symbol = Symbol('@aedart/contracts/support/concerns/applied-aliases');